...
function ResDrawer({
  initial, defaultDate, rid, onClose, onSave,
}: {
...
function ReservationsContent() {
  ...
  // Fetch ALL reservations for this restaurant — filter client-side
    ...
    <div style={{
      ...
      <header style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <span style={{ fontSize: 13, fontWeight: 600, color: TX2 }}>{slug}</span>
          <div style={{ width: 1, height: 24, background: BR }} />
