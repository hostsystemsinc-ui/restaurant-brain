// NFC puck entry point — The Original Walnut Cafe
// Program NFC pucks with: https://hostplatform.net/walnut/original/puck
//
...
export default function OriginalPuckPage() {
  redirect("/walnut/original/join?src=nfc")
}
