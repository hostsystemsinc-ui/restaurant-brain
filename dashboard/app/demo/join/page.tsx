  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center px-8 pt-12 pb-5 shrink-0">
        <p className="text-xs tracking-[0.4em] uppercase mb-2" style={{ color: "rgba(255,255,255,0.55)" }}>
          Powered by
        </p>
        <h1 className="text-4xl font-bold" style={{ letterSpacing: "0.35em" }}>HOST</h1>
      </div>
      ...
      <div className="flex flex-col items-center px-8 pb-5 shrink-0">
        <div
          ...
          style={{
            width: "200px", height: "76px", borderRadius: "14px",
            border: "1px solid rgba(255,255,255,0.12)",
            background: "rgba(255,255,255,0.04)",
          }}
        >
          <span style={{ fontSize: 18, fontWeight: 800, letterSpacing: "0.12em", color: "rgba(255,255,255,0.88)" }}>
      ...
      <div className="flex flex-col items-center gap-3 py-5 px-8 shrink-0">
        ...
        <div className="flex items-center gap-9">
          <button
            ...
            style={{ border: "1px solid rgba(255,255,255,0.22)", color: partySize <= 1 ? "rgba(255,255,255,0.2)" : "white" }}
          >
          ...
          <button
            ...
            className="w-11 h-11 rounded-full flex items-center justify-center transition-all active:scale-95"
            style={{ border: "1px solid rgba(255,255,255,0.22)", color: partySize >= 20 ? "rgba(255,255,255,0.2)" : "white" }}
          >
      ...
      <div className="flex-1 flex flex-col justify-center gap-6 px-8">
        <div className="flex flex-col gap-2">
          <p className="text-xs tracking-[0.3em] uppercase" style={{ color: "rgba(255,255,255,0.65)" }}>Name</p>
          <input
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            type="tel" placeholder="SMS when your table is ready" value={phone}
      ...
      <div className="px-8 pb-8 pt-4 shrink-0">
        ...
        <button
          ...
          style={{ height: "64px", background: loading || joined ? "rgba(255,255,255,0.35)" : "white", color: "black" }}
        >
      ...
      {joined && (
        <div style={{
          ...
          background: "#000", animation: "overlayIn 0.28s cubic-bezier(0.4,0,0.2,1) both",
        }}>
          <p style={{ fontSize: 10, letterSpacing: "0.55em", textTransform: "uppercase", color: "rgba(255,255,255,0.38)", marginBottom: 14, animation: "subtleUp 0.45s 0.18s ease-out both" }}>
            You&apos;re in the queue
          </p>
          <p style={{ fontSize: 76, fontWeight: 900, letterSpacing: "0.28em", color: "#fff", lineHeight: 1, animation: "logoStamp 0.5s 0.26s cubic-bezier(0.34,1.56,0.64,1) both" }}>
            HOST
          </p>
          <p style={{ fontSize: 11, letterSpacing: "0.18em", color: "rgba(255,255,255,0.3)", marginTop: 20, animation: "subtleUp 0.45s 0.45s ease-out both" }}>
